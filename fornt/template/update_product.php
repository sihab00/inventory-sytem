  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="update_form_products" onsubmit="return false">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 form-group">
              ...
              <input type="text" class="form-control" name="update_product_name" id="update_product_name" placeholder="Username" required>
            </div>
          </div>
          ...
          <button type="submit" class="btn btn-primary mb-2">Update Products</button>
        </form>
      </div>
